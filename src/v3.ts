export const v3 = {
  "productName": "Chapter Expansion Kit",
  ...
  "capabilities": [
    "Domain-specific workbench: Expansion Readiness Lab",
    "Operational table: Candidate city plan",
  ...
  "releaseChecklist": [
    ...
    "City Readiness reaches production threshold",
    "Leader Readiness is documented with evidence",
    "Risk Mitigation has no unresolved blocker",
    "Expansion memo verified",
    "Launch plan verified",
