...
**Chapter Expansion Kit** is a polished, local-first open-source tool from Volta's open-source program. It helps Volta leadership and prospective regional directors turn real community work into structured evidence, client-safe handoffs, and mentor-reviewable release packets.
