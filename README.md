...
# 🎓 Chapter Expansion Kit

### A public playbook for evaluating, onboarding, and launching new city chapters.
...
**Student Agency Operations** · **Repo 47/50** · **No backend. No login. Client data stays local.**
...
**Chapter Expansion Kit** is a polished, local-first open-source tool from Volta's 50-project OSS division. It helps Volta leadership and prospective regional directors turn real community work into structured evidence, client-safe handoffs, and mentor-reviewable release packets.
...
Expansion can dilute quality if new chapters lack readiness criteria and launch standards.

### The niche

Quality-controlled nonprofit chapter growth.

### North-star metric

`new chapters launched with readiness evidence`
...
flowchart TD
    ...
    Evidence --> Workbench["Chapter Expansion Kit"]
    Workbench --> Score["Operating readiness"]
    Score --> Cert["v3 production certification"]
    Cert --> A1["Expansion memo"]
    Cert --> A2["Launch plan"]
    Cert --> A3["Risk register"]
...
flowchart LR
    subgraph Modules["First-class modules"]
        M1["City readiness rubric"]
        M2["Leader interview guide"]
        M3["First 90 days plan"]
        M4["Launch risk register"]
    end
    M1 --> Workbench
    M2 --> Workbench
    M3 --> Workbench
...
sequenceDiagram
    ...
    participant T as Chapter Expansion Kit
...
|---|---|
| **Domain workbench** | A purpose-built expansion planner interface for a public playbook for evaluating, onboarding, and launching new city chapters. |
...
|---:|---|---|
| 1 | **City readiness rubric** | Converts field work into repeatable, reviewable Volta delivery evidence. |
| 2 | **Leader interview guide** | Converts field work into repeatable, reviewable Volta delivery evidence. |
| 3 | **First 90 days plan** | Converts field work into repeatable, reviewable Volta delivery evidence. |
| 4 | **Launch risk register** | Converts field work into repeatable, reviewable Volta delivery evidence. |
